...
public class NFCPluginTest extends UnityPlayerActivity
{
    ...
    //reference to single application context
    public static Context mContext; //mAppContext; // = this.getApplicationContext
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Foreground Dispatch: 1. Creates a PendingIntent object so the Android system
        // can populate it with the details of the tag when it is scanned.
    ...
    //This method checks if the intent contains the data of a NFC tag NDEF formatted.
    //Iterates over its NDEF messages, and extracts the Text and URI records to the s String
    ...
    //helper method to get text info from NFC reader's result
    ...
    //static helper method to check nfc enabled/disabled state
    public static boolean isNfcEnabledStatic()
    {
        //TODO comment later
        Log.d("TAG","Static method was called");
    ...
    //static helper method to show NFC state toast
    public static void showNFCStateToastStatic()
    {
        String toastString = isNfcEnabledStatic() ? "NFC is enabled" : "NFC is disabled";

        Toast.makeText(mContext, toastString,
                Toast.LENGTH_SHORT).show();
    } // showNFCStateToastStatic



    // static helper method to show NFC state toast
    public void showNFCStateToast()
    {
        String toastString = isNfcEnabled() ? "NFC is enabled" : "NFC is disabled";
    ...
    //static helper method to launch NFC settings
    public static void openNFCSettingsStatic()
    {
        mContext.startActivity(new Intent(android.provider.Settings.ACTION_NFC_SETTINGS));
    } // openNFCSettingsStatic



    //helper method to launch NFC settings
